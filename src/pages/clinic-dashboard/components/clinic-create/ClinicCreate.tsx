...
function getOtchError(otch: string, isDirty: boolean) {
  if (isDirty && !otch) return "Поле обязательно для заполнения.";
  return null;
}

function getSpecialtyError(specialty: string, isDirty: boolean) {
  if (isDirty && !specialty) return "Поле обязательно для заполнения.";
  return null;
}
        ...
        <div className="card-content">
          ...
          <div className="input-field">
            <label htmlFor="firstName">
              Имя: <span className={"red-text"}>*</span>
            </label>
            <input
              id="firstName"
              type="text"
          ...
          <div className="input-field">
            <label htmlFor="lastName">
              Фамилия: <span className={"red-text"}>*</span>
            </label>
            <input
              id="lastName"
              type="text"
            ...
            />
            <span className="helper-text red-text">{famErrorMessage}</span>
          </div>

          <div className="input-field">
            <label htmlFor="middleName">
              Отчество: <span className={"red-text"}>*</span>
            </label>
            <input
              id="middleName"
              type="text"
              onChange={(event) => {
                setOtch(event.target.value);
                setServerErrorMessage("");
              }}
            />
            <span className="helper-text red-text">{otchErrorMessage}</span>
          </div>

          <div className="input-field">
            <label htmlFor="specialty">
              Специальность: <span className={"red-text"}>*</span>
            </label>
            <input
              id="specialty"
              type="text"
          ...
          <div className="input-field">
            ...
            />
            <span className="helper-text red-text">{emailErrorMessage}</span>
          </div>

          <div className="input-field">
            <label htmlFor="password">
              Пароль: <span className={"red-text"}>*</span>
            </label>
            <input
              autoComplete="one-time-code"
              id="password"
            ...
            />
            <span className="helper-text red-text">{passErrorMessage}</span>
          </div>
        </div>
