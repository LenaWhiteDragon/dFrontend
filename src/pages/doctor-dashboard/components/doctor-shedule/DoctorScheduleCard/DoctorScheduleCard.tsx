    ...
    <div className="schedule-list">
      <div className="schedule-item">
        <div className="schedule-details">
          ...
          <p>
            <strong>Пациент:</strong> {props.patient_name}{" "}
          </p>
          <p>
            <strong>Телефон:</strong> {props.patient_phone}{" "}
          </p>
          <p>
            <strong>Проблема:</strong> {props.problem_description}{" "}
          </p>
          <button
            onClick={() => navigate("/mydoctor/medinfo/" + props.patient_id)}
            className="btn"
          >
